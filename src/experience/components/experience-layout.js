    ...
    return (
        <Media>
            ...
            <Media.Body>
                <h5>{props.title}</h5>
                <p>
                    <strong>Web UI Developer</strong>. {props.content}
            ...
            <Media.Body>
                ...
                <Media>
                    ...
                    <ul className="experience-ul row ml-1">
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-html5"></i>HTML5</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-css3"></i>CSS3</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-css3"></i>CSS Grid Layout</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-css3"></i>CSS FlexBox</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-sass"></i>SASS</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fas fa-cube"></i>Webpack</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-js"></i>Javascript</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-react"></i>ReactJS</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-react"></i>NextJS</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fas fa-th"></i>Bootstrap</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fas fa-th"></i>ZURB Foundation</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-wordpress"></i>Wordpress</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fas fa-code-branch"></i>Git</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-bitbucket"></i>BitBucket</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-github"></i>GitHub</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fas fa-upload"></i>Deploy</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-adobe"></i>Adobe Photoshop</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-adobe"></i>Adobe XD</li>
                        <li className="col-sm-3 col-md-2 text-left border-bottom border-primary rounded-right mr-3 mt-3"><i className="fab fa-adobe"></i>Adobe Illustrator</li>
                    </ul>
            </Media.Body>
        </Media> */
    );
